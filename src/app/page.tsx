      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-3">
            Birlikte Yaşadığımız Güzel Anıları Burada Saklayalım
          </p>
          <p className="text-base text-gray-500 max-w-2xl mx-auto">
            Her şehir, her gülümseme, her anı burada güvenle duruyor.
          </p>
        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            className={`hover:bg-blue-50 hover:text-blue-600 transition-colors ${
                              theme === 'green-theme' ? 'hover:bg-blue-50' : 'hover:bg-blue-50'
                            }`}
                          >
                          ...
                          <Button
                            ...
                            className={`hover:bg-red-50 hover:text-red-600 transition-colors ${
                              theme === 'green-theme' ? 'hover:bg-red-50' : 'hover:bg-red-50'
                            }`}
                          >
